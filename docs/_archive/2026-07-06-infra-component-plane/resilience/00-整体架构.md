...
| Status Snapshot | 暴露只读 runtime 状态，不提供动态调参/drain/release | `resilience.StatusService` |
...
| Redis distributed limit | `internal/pkg/resilience/ratelimit/redisadapter` |
| SubmitQueue | `internal/collection-server/application/answersheet` |
| Backpressure | `internal/pkg/resilience/backpressure` |
| LockLease | `internal/pkg/resilience/locklease` |
...
`resilience.RuntimeSnapshot` 是只读状态模型。
...
- Runtime status：[../../../internal/pkg/resilience/status.go](../../../internal/pkg/resilience/status.go)
- Prometheus metrics：[../../../internal/pkg/resilience/prometheus.go](../../../internal/pkg/resilience/prometheus.go)

### RateLimit

- Middleware limit：[../../../internal/pkg/middleware/limit.go](../../../internal/pkg/middleware/limit.go)
- RateLimit package：[../../../internal/pkg/resilience/ratelimit/](../../../internal/pkg/resilience/ratelimit/)
- Redis adapter：[../../../internal/pkg/resilience/ratelimit/redisadapter/](../../../internal/pkg/resilience/ratelimit/redisadapter/)
