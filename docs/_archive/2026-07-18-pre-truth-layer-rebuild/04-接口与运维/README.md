...
├── 11-300QPS混合场景压测SOP.md
├── 12-小程序报告等待接入指南.md
├── 13-小程序人格测评前端接入指南.md
├── 14-Interpretation旧集合退役.md
├── 15-小程序接入文档.md
└── 16-测评后台接入文档.md
```
...
| 12 | [11-300QPS混合场景压测SOP.md](./11-300QPS混合场景压测SOP.md) | 300 QPS 混合场景、k6/ghz 命令、异步链路观测与结果模板 |
| 13 | [12-小程序报告等待接入指南.md](./12-小程序报告等待接入指南.md) | 报告等待三方案（WS / 短轮询 / 长轮询）、人格与医学 URL、降级与联调 |
| 14 | [13-小程序人格测评前端接入指南.md](./13-小程序人格测评前端接入指南.md) | 人格测评前端接入与契约 |
| 15 | [14-Interpretation旧集合退役.md](./14-Interpretation旧集合退役.md) | catalog 对账后备份、drop 旧报告集合及回滚门禁 |
| 16 | [15-小程序接入文档.md](./15-小程序接入文档.md) | 小程序现行全链路：session、答卷双 ID、报告状态与报告展示 |
| 17 | [16-测评后台接入文档.md](./16-测评后台接入文档.md) | ModelCatalog、Evaluation、Interpretation 重构后的后台迁移与接入 |
