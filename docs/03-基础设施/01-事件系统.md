...
| 契约模型 | `internal/pkg/eventcatalog` 是 `events.yaml` 的代码真值层；`eventconfig` 只保留兼容 facade 与 runtime adapter |
...
- 兼容 facade 与 runtime adapter：[`internal/pkg/eventconfig/`](../../internal/pkg/eventconfig/)
- Worker 订阅与分发：[`internal/worker/application/event_dispatcher.go`](../../internal/worker/application/event_dispatcher.go)、[`internal/worker/integration/messaging/runtime.go`](../../internal/worker/integration/messaging/runtime.go)、[`internal/worker/process/runtime_bootstrap.go`](../../internal/worker/process/runtime_bootstrap.go)
...
`qs-apiserver` 启动时先根据 `messaging.*` 创建底层 `messaging.Publisher`，再装配成 [`RoutingPublisher`](../../internal/pkg/eventconfig/publisher.go)。`RoutingPublisher` 只负责运行时发布路由；事件契约查询来自 [`eventcatalog.Catalog`](../../internal/pkg/eventcatalog/catalog.go)，payload 与 metadata 构造来自 [`eventcodec`](../../internal/pkg/eventcodec/codec.go)。
...
| 发布端 | [`internal/pkg/eventconfig/publisher.go`](../../internal/pkg/eventconfig/publisher.go) |
| Worker 分发 | [`internal/worker/application/event_dispatcher.go`](../../internal/worker/application/event_dispatcher.go)、[`internal/worker/integration/messaging/runtime.go`](../../internal/worker/integration/messaging/runtime.go)、[`internal/worker/process/runtime_bootstrap.go`](../../internal/worker/process/runtime_bootstrap.go) |
| 共享事件模型 | [`pkg/event/event.go`](../../pkg/event/event.go) |
