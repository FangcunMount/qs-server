...
| 维度 | 当前事实 |
| ---- | -------- |
| family 状态 | 由 `cachegovernance/observability.FamilyStatusRegistry` 维护 |
...
```mermaid
flowchart LR
    Runtime["cacheplane.Runtime"] --> Status["FamilyStatusRegistry"]
...
- [cachegovernance/observability](../../../internal/pkg/cachegovernance/observability)
