...
- [Migration & Recovery](./migration-recovery/README.md) 回答 schema、dirty、one-off 和生产恢复如何受控。
...
- [Config & Deployment](./config-deployment/README.md) 回答有效配置、Secret、镜像、网络与 exact-SHA 部署如何闭环。
