...
| **Redis** | apiserver 读侧缓存、statistics query cache、collection 操作性 Redis、worker 分布式锁 | [infra/cache](../../internal/apiserver/infra/cache)、[infra/cachequery](../../internal/apiserver/infra/cachequery)、[infra/statistics/cache.go](../../internal/apiserver/infra/statistics/cache.go)、[redislock](../../internal/pkg/redislock) |
