...
本文档按 [CONTRIBUTING-DOCS.md](../CONTRIBUTING-DOCS.md) 的讲解维度组织。**按业务聚合的表级细节**以各 [02-业务模块](../02-业务模块/) 为准；本文只固定 **MySQL / MongoDB / Redis 分工**、**进程接入方式**与**与 02 的索引关系**。
...
| collection / worker DB | [internal/collection-server/database.go](../../internal/collection-server/database.go)、[internal/worker/database.go](../../internal/worker/database.go) |
