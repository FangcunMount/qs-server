...
- **连接与迁移**：[`internal/apiserver/bootstrap/database.go`](../../internal/apiserver/bootstrap/database.go)、[`internal/apiserver/process/resource_bootstrap.go`](../../internal/apiserver/process/resource_bootstrap.go)、[`internal/pkg/migration/`](../../internal/pkg/migration/)（MySQL / MongoDB 分离目录）。
...
| 关注点 | 路径 |
| ------ | ---- |
| apiserver DB | [internal/apiserver/bootstrap/database.go](../../internal/apiserver/bootstrap/database.go)、[internal/apiserver/process/resource_bootstrap.go](../../internal/apiserver/process/resource_bootstrap.go) |
| collection / worker DB | [internal/collection-server/bootstrap/database.go](../../internal/collection-server/bootstrap/database.go)、[internal/worker/bootstrap/database.go](../../internal/worker/bootstrap/database.go) |
...
| **Redis** | apiserver 读侧缓存、statistics query cache、collection 操作性 Redis、worker 分布式锁 | [infra/cache](../../internal/apiserver/infra/cache)、[infra/cachequery](../../internal/apiserver/infra/cachequery)、[infra/statistics/cache.go](../../internal/apiserver/infra/statistics/cache.go)、[locklease](../../internal/pkg/locklease) |
