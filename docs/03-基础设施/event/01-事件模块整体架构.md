...
| 问题 | 当前答案 | 主要事实源 |
| --- | --- | --- |
| 事件名称、Topic、handler 在哪定义 | `configs/events.yaml` 是运行时目录 | `configs/events.yaml`、`internal/pkg/eventing/catalog` |
| 事件包结构是什么 | `id/eventType/occurredAt/aggregateType/aggregateID/data` | `component-base/pkg/event`、`component-base/pkg/eventcodec` |
...
| Signal 是否可靠 | 不可靠，只用于唤醒、失效和预热 | `internal/pkg/reportstatus`、`internal/pkg/cache/signal` |
...
| 当前是否有完整 Effective Event Registry | 有；启动时合并 YAML 与 EventSpec | `internal/pkg/eventing/catalog` |
...
| 代码事件常量 | `internal/pkg/eventing/catalog/types.go` |
| payload | `internal/pkg/eventing/payload`、`internal/pkg/eventing/outcome` |
| producer 构造器 | 各领域包 `events.go` |
| worker handler factory | `internal/worker/handlers/catalog.go` |
| owner / profile / immediate / priority / idempotency / settlement | `internal/pkg/eventing/catalog/spec.go` |
| 有效运行策略 | `internal/pkg/eventing/catalog.EffectiveRegistry` |
...
| Signal 名称/payload | `internal/pkg/cache/signal`、`internal/pkg/reportstatus` |
...
| 事件基础类型 | [component-base/pkg/event](https://github.com/FangcunMount/component-base/tree/v0.6.3/pkg/event) |
| catalog 和代码事件常量 | [../../../internal/pkg/eventing/catalog](../../../internal/pkg/eventing/catalog) |
| envelope 编解码 | [component-base/pkg/eventcodec](https://github.com/FangcunMount/component-base/tree/v0.6.3/pkg/eventcodec) |
| publish / subscriber runtime | [../../../internal/pkg/eventing/runtime](../../../internal/pkg/eventing/runtime) |
...
| 缓存 Signal | [../../../internal/pkg/cache/signal](../../../internal/pkg/cache/signal) |
