...
当前主链机制已经稳定：Event Catalog、Mongo/MySQL Outbox、immediate、ready index、relay、MQ 和 worker ACK/NACK 均已可运行。下一阶段主要解决契约有效视图、Outbox runtime 所有权和子系统组合根问题，见 [10-事件工程化设计.md](10-事件工程化设计.md)。
...
| 当前运行策略 | [../../../internal/apiserver/container/internal/outboxruntime](../../../internal/apiserver/container/internal/outboxruntime)、[../../../internal/pkg/outboxpriority](../../../internal/pkg/outboxpriority) |
| 工程化目标 | [10-事件工程化设计.md](10-事件工程化设计.md) |
