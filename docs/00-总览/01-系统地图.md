...
**代码锚点**：collection [integration/grpcclient/registry.go](../../internal/collection-server/integration/grpcclient/registry.go)；worker [application/event_dispatcher.go](../../internal/worker/application/event_dispatcher.go) 与 [handlers/](../../internal/worker/handlers/)。
