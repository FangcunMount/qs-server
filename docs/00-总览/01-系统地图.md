...
| Assessment Model | 模型资产 | `AssessmentKind`、发布快照、模型绑定、Scale / Personality payload | `../02-业务模块/assessment-model/README.md` |
| Evaluation | 测评执行 | `Assessment`、`EvaluationRun`、执行状态机、执行结果、失败 / 重试 | `../02-业务模块/evaluation/README.md` |
| Interpretation Model / Report | 解释报告 | `InterpretReport`、report builder、score/personality adapter、报告持久化 | `../02-业务模块/interpretation-model/README.md` |
