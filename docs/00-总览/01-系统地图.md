...
**装配锚点**：[internal/apiserver/container/container.go](../../internal/apiserver/container/container.go)，各模块 [internal/apiserver/container/assembler/*.go](../../internal/apiserver/container/assembler/)。
...
**代码锚点**：collection [grpc_client_registry.go](../../internal/collection-server/grpc_client_registry.go)；worker [application/event_dispatcher.go](../../internal/worker/application/event_dispatcher.go) 与 [handlers/](../../internal/worker/handlers/)。
...
- **不存在**独立的 `screening` 装配模块时，勿把旧设计稿当现状。  
