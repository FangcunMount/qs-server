...
| -------- | --------------- | -------- | ---------- | ---------------- | -------- |
| Survey | `survey` | `internal/apiserver/domain/survey` | `internal/apiserver/application/survey` | Mongo answersheet、questionnaire repo/cache 等 | [`docs/02-业务模块/survey`](../02-业务模块/survey/) |
| Assessment Model | `assessmentmodel`，兼容注册 `scale/personalitymodel` | `internal/apiserver/domain/assessmentmodel`、`internal/apiserver/domain/assessmentmodel/scale` | `internal/apiserver/application/assessmentmodel`，旧能力路径仍包括 `application/scale`、`application/personalitymodel` | assessmentmodel/scale Mongo mapper、catalog、规则适配等 | [`docs/02-业务模块/assessment-model`](../02-业务模块/assessment-model/) |
| Evaluation | `evaluation` | `internal/apiserver/domain/evaluation` | `internal/apiserver/application/evaluation` | assessment repo、evaluation input resolver、report saver 调用边界 | [`docs/02-业务模块/evaluation`](../02-业务模块/evaluation/) |
| Interpretation Model / Report | `report` | `internal/apiserver/domain/report` | 当前主要由 `container/modules/report` 装配 builder registry 与 durable saver | report builder registry、report repo、adapter | [`docs/02-业务模块/interpretation-model`](../02-业务模块/interpretation-model/) |
| Actor | `actor` | `internal/apiserver/domain/actor` | `internal/apiserver/application/actor` | actor read model、testee/clinician repo/cache | [`docs/02-业务模块/actor`](../02-业务模块/actor/) |
| Plan | `plan` | `internal/apiserver/domain/plan` | `internal/apiserver/application/plan` | plan/task repo、scheduler、通知上下文 | [`docs/02-业务模块/plan`](../02-业务模块/plan/) |
| Statistics | `statistics` | `internal/apiserver/domain/statistics` | `internal/apiserver/application/statistics` | statistics read model/cache/projection | [`docs/02-业务模块/statistics`](../02-业务模块/statistics/) |
