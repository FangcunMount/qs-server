...
| internal gRPC | [`internalapi/internal.proto`](../../api/grpc/gen/internalapi/internal.proto) | worker 回调 apiserver 的内部服务契约 |
...
| Scale | `internal/apiserver/domain/assessmentmodel/scale/definition` | `internal/apiserver/application/scale` | Mongo/MySQL scale mapper、规则适配等 | [`docs/02-业务模块/scale`](../02-业务模块/scale/) |
...
| 量表因子、计分规则、解读规则 | `domain/assessmentmodel/scale/definition`、`application/scale` |
