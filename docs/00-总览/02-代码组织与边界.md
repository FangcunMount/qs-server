...
│   │   ├── infra/                      # MQ、gRPC 客户端等
│   │   └── container/
│   └── pkg/                            # 三进程共享：grpc server、middleware、migration、eventconfig…
...
| ---- | --------------------- | ----------- |
| **apiserver** | [internal/apiserver/app.go](../../internal/apiserver/app.go)、[server.go](../../internal/apiserver/server.go) | [container/container.go](../../internal/apiserver/container/container.go)；REST [routers.go](../../internal/apiserver/routers.go)；gRPC [grpc_registry.go](../../internal/apiserver/grpc_registry.go) |
| **collection-server** | [internal/collection-server/app.go](../../internal/collection-server/app.go)、[server.go](../../internal/collection-server/server.go) | [container/container.go](../../internal/collection-server/container/container.go)；gRPC 客户端 [grpc_client_registry.go](../../internal/collection-server/grpc_client_registry.go) |
| **worker** | [internal/worker/app.go](../../internal/worker/app.go)、[server.go](../../internal/worker/server.go) | [container/container.go](../../internal/worker/container/container.go) |
