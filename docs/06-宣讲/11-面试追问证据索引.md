...
| 怎么防止重复提交 | collection 使用 SubmitGuard 表达 idempotency guard，worker 使用 duplicate suppression gate | [../03-基础设施/resilience/04-LockLease幂等与重复抑制.md](../03-基础设施/resilience/04-LockLease幂等与重复抑制.md) |
...
| Lock lease | [internal/pkg/locklease](../../internal/pkg/locklease) |
