...
| **行为投影** | `footprint.*` 按产生边界写入 MySQL 或 Mongo outbox，再由 shared relay 出站 | [statistics `journey.go`](../../internal/apiserver/application/statistics/journey.go)、[durable_submit.go](../../internal/apiserver/infra/mongo/answersheet/durable_submit.go)、[engine/pipeline `interpretation.go`](../../internal/apiserver/application/evaluation/engine/pipeline/interpretation.go) |
