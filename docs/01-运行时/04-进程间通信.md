...
| apiserver | MQ | Publish | 经 **Container** 注入的 **`event.EventPublisher`**（[RoutingPublisher](../../internal/pkg/eventconfig/publisher.go)）；Topic 与 payload 与 [events.yaml](../../configs/events.yaml) 一致 |
