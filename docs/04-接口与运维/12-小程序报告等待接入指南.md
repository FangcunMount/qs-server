...
> **R110 破坏性变更**：`GET /api/v1/answersheets/{id}/assessment` 已下线。本文中「轮询 answersheets/{id}/assessment 拿 assessment_id」的步骤已失效，`assessment_id` 的获取路径需按新契约重新确定后回填。报告状态与正文接口不变。
