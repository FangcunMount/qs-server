...
internal gRPC 仍是受保护的进程边界。联调前准备：目标 SHA、目标方法的 proto、调用服务身份、CA/客户端证书、委托主体与测试资源。方法 ACL 和资源 ownership 的稳定语义见[身份、服务与资源授权](../03-基础设施/security/10-身份、服务与资源授权.md)，证书与网络边界见[敏感信息、网络暴露与验收](../03-基础设施/security/20-敏感信息、网络暴露与验收.md)。
