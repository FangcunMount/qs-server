...
| 业务模块边界 | Survey / Scale / Interpretation Model / Evaluation / Actor / Plan / Statistics 已拆开 |
| 多解释模型方向 | Scale 已收敛为具体解释模型，MBTI / BigFive 可作为同级模型接入 |
| 通用测评执行 | Evaluation 正在从结果模块升级为通用测评执行引擎 |
...
| 能力 | 当前状态 |
| ---- | -------- |
| 模块拆分 | Survey / Scale / Interpretation Model / Evaluation / Actor / Plan / Statistics |
