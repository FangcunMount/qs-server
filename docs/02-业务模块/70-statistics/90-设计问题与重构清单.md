...
| ST-V2-003 | P0 | 建立上海时间统一组件与迁移审计 | component-base 改造完成，待发布升级与历史审计 | 无 |
...
| ST-V2-008 | P1 | 实现 SyncRun 与批次状态机 | 三模式与精确停点完成，待故障演练 | 004-007 |
| ST-V2-009 | P1 | 建立 V2 查询契约与新鲜度字段 | 代码完成，待调用方验收 | 006-008 |
| ST-V2-010 | P1 | 建立机构级 Cache Generation 闭环 | 代码完成，待故障演练 | 008-009 |
