...
| ST-V2-003 | P0 | 建立上海时间统一组件与迁移审计 | 代码完成，历史审计待执行 | 无 |
...
| ST-V2-008 | P1 | 实现 SyncRun 与批次状态机 | 代码完成，待故障演练 | 004-007 |
| ST-V2-009 | P1 | 建立 V2 查询契约与新鲜度字段 | 代码完成，待调用方验收 | 006-008 |
| ST-V2-010 | P1 | 建立机构级 Cache Generation 闭环 | 代码完成，待故障演练 | 008-009 |
| ST-V2-011 | P1 | 历史 Fact 回填与归属标记 | 工具完成，待执行 | 001-008 |
| ST-V2-012 | P1 | V1/V2 影子对账与逐接口切换 | 开关与适配器完成，待影子期 | 009-011 |
