...
- 同步编排：[`application/statistics/coordinator.go`](../../../internal/apiserver/application/statistics/coordinator.go)
...
- ReadStore：[`infra/mysql/statistics/read_store.go`](../../../internal/apiserver/infra/mysql/statistics/read_store.go)
- RunStore：[`infra/mysql/statistics/run_store.go`](../../../internal/apiserver/infra/mysql/statistics/run_store.go)
