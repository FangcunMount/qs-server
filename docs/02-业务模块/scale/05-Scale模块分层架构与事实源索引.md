...
```text
internal/apiserver/domain/scale/medical_scale.go
internal/apiserver/domain/scale/lifecycle.go
internal/apiserver/domain/scale/baseinfo.go
internal/apiserver/domain/scale/factor.go
internal/apiserver/domain/scale/scoring_spec.go
internal/apiserver/domain/scale/interpretation_rules.go
internal/apiserver/domain/scale/interpretation_rule.go
internal/apiserver/domain/scale/types.go
internal/apiserver/domain/scale/errors.go
internal/apiserver/domain/scale/events.go
internal/apiserver/domain/scale/validator.go
```
