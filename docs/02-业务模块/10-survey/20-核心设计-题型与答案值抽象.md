...
| AnswerValue / adapters | [`answer.go`](../../../internal/apiserver/domain/survey/answersheet/answer.go)、[`validation_adapter.go`](../../../internal/apiserver/domain/survey/answersheet/validation_adapter.go)、[`scoring_service.go`](../../../internal/apiserver/domain/survey/answersheet/scoring_service.go) |
