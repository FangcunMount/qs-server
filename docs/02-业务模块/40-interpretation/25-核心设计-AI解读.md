...
索引与迁移由 Mongo migration 25～33 管理，覆盖运行集合、评测证据、日预算、活跃槽、人工重试、TTL、数据主体导出和治理目录稳定分页。专用 Replica Set 集成测试入口验证事务回滚、唯一约束、冷启动 Schema 和 TTL Monitor；当前仍需要分支 CI 的实际运行证据。
