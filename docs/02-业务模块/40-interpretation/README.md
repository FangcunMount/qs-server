...
**本文回答**：Interpretation Model 如何把 Evaluation 的结构化结果转换成用户可理解的 `InterpretReport`。当前代码实现仍位于 `report` module。
...
| 上游 | `assessment-model` | 提供模型身份、快照和解释绑定 |
...
- [`internal/apiserver/container/modules/report`](../../../internal/apiserver/container/modules/report/)
