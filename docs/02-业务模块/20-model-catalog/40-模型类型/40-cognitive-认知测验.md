...
发布成功后，AssessmentSnapshot 只冻结 DefinitionV2 和精确运行身份；cognitive runtime DTO 在内存中从 DefinitionV2 物化，不保留旧格式 decoder。
...
- [cognitive Norm runtime 投影测试](../../../../internal/apiserver/port/modelcatalog/payload/cognitive/runtime_norm_projection_test.go)
