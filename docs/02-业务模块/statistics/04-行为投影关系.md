...
| analytics projection | 面向统计接口的读模型 | 查询快，但依赖异步投影最终一致 |
...
| 模式 | 位置 | 作用 |
| ---- | ---- | ---- |
| Projector | behavior projection | 将事件事实转成 episode/projection |
| Read Model | statistics projection | 支撑高效统计查询 |
...
sequenceDiagram
    ...
    participant Projection as analytics_projection
