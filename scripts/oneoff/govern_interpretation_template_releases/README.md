...
对 Interpretation `legacy-v1` ReportTemplate release 执行 manifest 驱动的审计、物化、验证和回滚。
...
3. 保留现有 release 的 ID、生命周期时间、发布人和旧身份字段；
4. 不修改任何 Generation、Artifact、Outcome 或 ModelCatalog snapshot。
