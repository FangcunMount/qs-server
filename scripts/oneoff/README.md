...
| `audit_evaluation_p1_evidence.sql` | P1 EV-R010/R012 只读证据：执行时长相对 120s Lease、Outcome schema/ReportInput 分布 | 无写入 |
| `audit_evaluation_p2_evidence.sql` | P2 EV-R016 只读证据：active claim / lease remaining / lease_recovery 与 attempt churn | 无写入 |
