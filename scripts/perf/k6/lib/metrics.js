...
export const medicalReportWsSubscribeToFirstMessageLatency = new Trend('medical_report_ws_subscribe_to_first_message_latency', true);
export const behaviorReportWsSubscribeToFirstMessageLatency = new Trend('behavior_report_ws_subscribe_to_first_message_latency', true);
export const personalityReportWsSubscribeToFirstMessageLatency = new Trend('personality_report_ws_subscribe_to_first_message_latency', true);
