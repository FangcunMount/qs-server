...
const docTemplate = `{
    ...
    "paths": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/github_com_FangcunMount_qs-server_internal_collection-server_application_aiexplanation.ExportPage"
                                        }
                                    }
                                }
                            ]
        ...
        "/api/v1/assessment-models": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "模型主类；医学量表使用 canonical category code",
                        "name": "category",
                        "in": "query"
                    },
                    {
        ...
        "/api/v1/assessments/{id}/ai-explanation/capability": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/aiexplanation.Response"
                                        }
                                    }
                                }
                            ]
        ...
        "/api/v1/assessments/{id}/ai-explanations": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/aiexplanation.Request"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/assessments/{id}/ai-explanations/{generation_id}": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/github_com_FangcunMount_qs-server_internal_collection-server_application_aiexplanation.WorkflowResult"
                                        }
                                    }
                                }
                            ]
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/governance.ComponentCacheGovernanceSnapshot"
                        }
                    }
                }
            }
    ...
    "definitions": {
        "aiexplanation.Content": {
            ...
            "properties": {
                "integrated_insights": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/aiexplanation.IntegratedInsight"
                    }
                },
                "limitations": {
                    "type": "array",
                ...
                "schema_version": {
                    "type": "string",
                    "example": "ai-explanation-output/v1"
                },
                "suggestions": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/aiexplanation.Suggestion"
                    }
                },
                "summary": {
                    "type": "string"
        ...
        "aiexplanation.ExportReleaseReceipt": {
            "type": "object",
            "properties": {
        ...
        "aiexplanation.ExportSourceReceipt": {
            "type": "object",
            "properties": {
                "assessment_id": {
                    "type": "string"
        ...
        "aiexplanation.IntegratedInsight": {
            "type": "object",
            "properties": {
                "content": {
                    "type": "string"
                ...
                "evidence_refs": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/aiexplanation.EvidenceRef"
                    }
                },
                "kind": {
                    "type": "string",
        ...
        "aiexplanation.Response": {
            ...
            "properties": {
                ...
                "content": {
                    "$ref": "#/definitions/aiexplanation.Content"
                },
                "created_at": {
                    "type": "string"
                },
                "failure": {
                    "$ref": "#/definitions/aiexplanation.Failure"
                },
                "generation_id": {
                    "type": "string"
                },
        ...
        "github_com_FangcunMount_qs-server_internal_collection-server_application_aiexplanation.ExportPage": {
            "type": "object",
            "properties": {
                "exported_at": {
                    "type": "string"
                ...
                "items": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/github_com_FangcunMount_qs-server_internal_collection-server_port_aiexplanation.ExportItem"
                    }
                },
                "next_cursor": {
                    "type": "string"
        ...
        "github_com_FangcunMount_qs-server_internal_collection-server_application_aiexplanation.WorkflowResult": {
            "type": "object",
            "properties": {
                "artifact_id": {
                    "type": "string"
        ...
        "github_com_FangcunMount_qs-server_internal_collection-server_port_aiexplanation.ExportItem": {
            "type": "object",
            "properties": {
                "artifact_id": {
                    "type": "string"
                ...
                "release": {
                    "$ref": "#/definitions/aiexplanation.ExportReleaseReceipt"
                },
                "source": {
                    "$ref": "#/definitions/aiexplanation.ExportSourceReceipt"
                }
            }
        },
        "governance.CapabilityPolicyView": {
            "type": "object",
            "properties": {
                "capability": {
                    "type": "string"
                ...
                "effective": {
                    "$ref": "#/definitions/governance.PolicyView"
                },
                "enabled": {
                    "type": "boolean"
                },
        ...
        "governance.ComponentCacheGovernanceSnapshot": {
            "type": "object",
            "properties": {
                "component": {
                    "type": "string"
                ...
                "effective_registry": {
                    "$ref": "#/definitions/governance.EffectiveRegistrySnapshot"
                },
                "generated_at": {
                    "type": "string"
                },
                ...
                "l1_runtime": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/governance.L1CapabilityRuntime"
                    }
                },
                "redis_runtime": {
        ...
        "governance.EffectiveRegistrySnapshot": {
            "type": "object",
            "properties": {
                "capabilities": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/governance.CapabilityPolicyView"
                    }
                },
                "catalog_version": {
                    "type": "string"
                ...
                "policy_source": {
                    "$ref": "#/definitions/governance.PolicySourceView"
                },
                "reload": {
                    "$ref": "#/definitions/governance.PolicyReloadStatus"
                },
                "snapshot_version": {
                    "type": "integer"
                }
        ...
        "governance.L1CapabilityRuntime": {
            "type": "object",
            "properties": {
                "buckets": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/governance.L1BucketRuntime"
                    }
                },
                "capability": {
                    "type": "string"
                ...
                "signal_watcher": {
                    "$ref": "#/definitions/governance.SignalWatcherStatus"
                }
            }
        },
        "governance.PolicyReloadStatus": {
            "type": "object",
            "properties": {
                "last_attempt_at": {
                    "type": "string"
        ...
        "governance.SignalWatcherStatus": {
            "type": "object",
            "properties": {
                "configured": {
                    "type": "boolean"
