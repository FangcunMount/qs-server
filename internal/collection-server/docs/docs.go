...
const docTemplate = `{
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/answersheet.SubmitStatusResponse"
                                        }
                                    }
                                }
                            ]
    ...
    "definitions": {
        ...
        "answersheet.SubmitStatusResponse": {
            "type": "object",
            "properties": {
                "answersheet_id": {
                    "type": "string"
                ...
                "assessment_id": {
                    "description": "AssessmentID 与 AnswerSheetID 共同构成 status=done 的完成不变量。",
                    "type": "string"
                },
                "status": {
                    "type": "string"
        ...
        "evaluation.AssessmentSummaryResponse": {
            ...
            "properties": {
                "answer_sheet_id": {
                    "description": "关联答卷 ID；提交后可用其与 answersheet_id 匹配取得 assessment_id（R121 后推荐方式）。",
                    "type": "string"
                },
                "created_at": {
                    "type": "string"
        ...
        "evaluation.ModelIdentityResponse": {
            ...
            "properties": {
                ...
                "kind": {
                    "description": "测评层 kind；人格线当前输出 personality（evaluation 过滤值），读兼容 typology。",
                    "type": "string",
                    "enum": [
                        "personality",
                        "typology"
        ...
        "typologysession.SessionEndpointsResponse": {
            ...
            "properties": {
                "assessment_by_answer_sheet": {
                    "description": "已下线（R121）端点 URL 模板，勿调用。assessment_id 请用 GET /typology-assessments 列表按 answer_sheet_id 匹配。",
                    "type": "string"
                },
                "report": {
                    "type": "string"
