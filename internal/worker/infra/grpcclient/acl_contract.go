...
func ACLAllowedMethods() []string {
	return []string{
		...
		interpretationpb.AIExplanationAutomationService_ExecuteAIExplanation_FullMethodName,
		interpretationpb.AIExplanationAutomationService_ExecutePromptEvaluationStep_FullMethodName,
