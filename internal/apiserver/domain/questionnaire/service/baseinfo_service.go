...
func (BaseInfoService) UpdateTitle(q *questionnaire.Questionnaire, newTitle string) error {
...
func (BaseInfoService) UpdateDescription(q *questionnaire.Questionnaire, newDescription string) error {
...
func (BaseInfoService) UpdateCoverImage(q *questionnaire.Questionnaire, imageURL string) error {
