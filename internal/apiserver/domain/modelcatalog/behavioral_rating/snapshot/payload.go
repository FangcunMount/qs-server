...
// Snapshot is the published behavioral_rating.default.v1 execution payload.
...
// ParseDefinitionPayload decodes behavioral_rating.default.v1 body into a runtime snapshot.
