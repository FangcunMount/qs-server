...
func TestCompatibleAlgorithmBindingMatrix(t *testing.T) {
	...
	cases := []struct {
		...
		{name: "typology_personality", kind: binding.KindTypology, subKind: binding.SubKindTypology, algorithm: binding.AlgorithmPersonalityTypology, want: true},
		{name: "typology_empty_draft", kind: binding.KindTypology, want: true},
		{name: "typology_rejects_mbti", kind: binding.KindTypology, subKind: binding.SubKindTypology, algorithm: binding.AlgorithmMBTI, want: false},
		{name: "typology_rejects_trait", kind: binding.KindTypology, subKind: binding.SubKindTrait, algorithm: binding.AlgorithmPersonalityTypology, want: false},
		...
		{name: "behavioral_rejects_default", kind: binding.KindBehavioralRating, algorithm: binding.AlgorithmBehavioralRatingDefault, want: false},
