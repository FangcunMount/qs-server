...
func Score(model *rulesetmbti.ModelSnapshot, answerSheet *evaluationinput.AnswerSheet) (ResultDetail, error) {
	if model == nil {
...
func dimensionMaxDeviation(meta rulesetmbti.DimensionSnapshot, mappings []rulesetmbti.QuestionMappingSnapshot) float64 {
