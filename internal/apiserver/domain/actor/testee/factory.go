...
func (f *factory) GetOrCreateByIAMChild(
	ctx context.Context,
	orgID int64,
	iamChildID int64,
	name string,
	...
	// 先尝试查找
	testee, err := f.repo.FindByIAMChild(ctx, orgID, iamChildID)
	if err == nil {
		return testee, nil
	}
...
func (f *factory) GetOrCreateByIAMUser(
	...
	// 先尝试查找
	testee, err := f.repo.FindByIAMUser(ctx, orgID, iamUserID)
	if err == nil {
		return testee, nil
	}
