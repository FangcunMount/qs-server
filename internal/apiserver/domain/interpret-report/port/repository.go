...
type InterpretReportRepositoryMongo interface {
	...
	FindByAnswerSheetId(ctx context.Context, answerSheetId meta.ID) (*interpretreport.InterpretReport, error)
	...
	ExistsByAnswerSheetId(ctx context.Context, answerSheetId meta.ID) (bool, error)
}
