...
func levelFromOutcome(outcome evaloutcome.Outcome) *domainreport.ResultLevel {
	if outcome.Execution == nil {
		return nil
	}
...
func attachOutcomeSummary(outcome evaloutcome.Outcome, report *domainreport.InterpretReport) *domainreport.InterpretReport {
