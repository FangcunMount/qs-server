...
type answerSheetRepositoryReadModel struct {
	repo domainanswersheet.Repository
}

func (r answerSheetRepositoryReadModel) ListAnswerSheets(ctx context.Context, filter surveyreadmodel.AnswerSheetFilter, page surveyreadmodel.PageRequest) ([]surveyreadmodel.AnswerSheetSummaryRow, error) {
	var (
...
func (r answerSheetRepositoryReadModel) CountAnswerSheets(ctx context.Context, filter surveyreadmodel.AnswerSheetFilter) (int64, error) {
