	...
	cases := []struct {
	...
	}{
		{
			...
			allowedImporters: []string{
				...
				"internal/apiserver/application/evaluation/registry/mechanisms/typology/report_builder.go",
				"internal/apiserver/application/evaluation/registry/mechanisms/typology/report_generic.go",
				"internal/apiserver/application/evaluation/registry/mechanisms/typology/report_generic_mechanism.go",
				"internal/apiserver/application/evaluation/registry/mechanisms/typology/report_input_mapper.go",
				"internal/apiserver/application/evaluation/registry/mechanisms/typology/report_registry.go",
				"internal/apiserver/application/evaluation/registry/mechanisms/typology/report_template.go",
		...
		},
		{
			...
			allowedImporters: []string{
				...
				"internal/apiserver/application/interpretation/reporting/writer/factory.go",
				"internal/apiserver/application/interpretation/reporting/writer/types.go",
				"internal/apiserver/application/interpretation/reporting/writer/waiter_notifier.go",
				"internal/apiserver/application/interpretation/reporting/writer/writer.go",
