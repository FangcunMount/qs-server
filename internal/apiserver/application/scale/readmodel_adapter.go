...
type scaleRepositoryReadModel struct {
	repo domainScale.Repository
}

func (r scaleRepositoryReadModel) ListScales(ctx context.Context, filter scalereadmodel.ScaleFilter, page scalereadmodel.PageRequest) ([]scalereadmodel.ScaleSummaryRow, error) {
...
func (r scaleRepositoryReadModel) CountScales(ctx context.Context, filter scalereadmodel.ScaleFilter) (int64, error) {
