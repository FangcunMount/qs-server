...
var transitionalModelFamilyPackages = map[string]string{
	...
	"internal/apiserver/application/evaluation/scale":             "transitional: factor_scoring application host",
	"internal/apiserver/application/evaluation/behavioral_rating": "transitional: factor_norm application host",
	"internal/apiserver/application/evaluation/cognitive":         "transitional: task_performance application host",
