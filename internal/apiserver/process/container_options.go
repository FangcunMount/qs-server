...
func (s *server) buildContainerOptions(input containerOptionsInput) container.ContainerOptions {
	...
	return container.ContainerOptions{
		...
		AIExplanation:              s.config.AIExplanation,
...
func (s *server) buildResilienceSubsystem(runtime *cacheplanebootstrap.RuntimeBundle) (*resiliencesubsystem.Subsystem, error) {
	...
	locks := locksubsystem.New(locksubsystem.Options{
		...
		EnabledWorkloads: map[locklease.WorkloadID]bool{
			...
			locklease.WorkloadAIExplanationPromptEvaluationLeaseRecovery: s.config.AIExplanationPromptEvaluationLeaseRecovery != nil && s.config.AIExplanationPromptEvaluationLeaseRecovery.Enable,
			locklease.WorkloadAIExplanationParticipantLeaseRecovery:      s.config.AIExplanationParticipantLeaseRecovery != nil && s.config.AIExplanationParticipantLeaseRecovery.Enable,
