...
func (UnimplementedInternalServiceServer) HandleQuestionnairePublishedPostActions(context.Context, *GenerateQuestionnaireQRCodeRequest) (*GenerateQuestionnaireQRCodeResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method HandleQuestionnairePublishedPostActions not implemented")
}
func (UnimplementedInternalServiceServer) GenerateScaleQRCode(context.Context, *GenerateScaleQRCodeRequest) (*GenerateScaleQRCodeResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GenerateScaleQRCode not implemented")
}
...
func _InternalService_SyncAssessmentAttention_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SyncAssessmentAttentionRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(InternalServiceServer).SyncAssessmentAttention(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: InternalService_SyncAssessmentAttention_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func (UnimplementedPlanCommandServiceServer) ResumePlan(context.Context, *ResumePlanRequest) (*ResumePlanResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ResumePlan not implemented")
}
func (UnimplementedPlanCommandServiceServer) FinishPlan(context.Context, *FinishPlanRequest) (*FinishPlanResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method FinishPlan not implemented")
}
...
func (UnimplementedPlanCommandServiceServer) EnrollTestee(context.Context, *EnrollTesteeRequest) (*EnrollTesteeResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method EnrollTestee not implemented")
}
func (UnimplementedPlanCommandServiceServer) TerminateEnrollment(context.Context, *TerminateEnrollmentRequest) (*TerminateEnrollmentResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method TerminateEnrollment not implemented")
}
func (UnimplementedPlanCommandServiceServer) SchedulePendingTasks(context.Context, *SchedulePendingTasksRequest) (*SchedulePendingTasksResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SchedulePendingTasks not implemented")
}
func (UnimplementedPlanCommandServiceServer) OpenTask(context.Context, *OpenTaskRequest) (*OpenTaskResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method OpenTask not implemented")
}
...
func (UnimplementedPlanCommandServiceServer) ExpireTask(context.Context, *ExpireTaskRequest) (*ExpireTaskResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ExpireTask not implemented")
}
...
func RegisterPlanCommandServiceServer(s grpc.ServiceRegistrar, srv PlanCommandServiceServer) {
	// If the following call panics, it indicates UnimplementedPlanCommandServiceServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
