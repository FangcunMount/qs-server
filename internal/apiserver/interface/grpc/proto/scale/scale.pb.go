...
type HotScaleSummary struct {
	state           protoimpl.MessageState `protogen:"open.v1"`
	Scale           *ScaleSummary          `protobuf:"bytes,1,opt,name=scale,proto3" json:"scale,omitempty"`
...
func (x *HotScaleSummary) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*HotScaleSummary) ProtoMessage() {}

func (x *HotScaleSummary) ProtoReflect() protoreflect.Message {
	mi := &file_scale_scale_proto_msgTypes[8]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use HotScaleSummary.ProtoReflect.Descriptor instead.
func (*HotScaleSummary) Descriptor() ([]byte, []int) {
	return file_scale_scale_proto_rawDescGZIP(), []int{8}
}

func (x *HotScaleSummary) GetScale() *ScaleSummary {
	if x != nil {
		return x.Scale
	}
	return nil
...
func (x *HotScaleSummary) GetRank() int32 {
	if x != nil {
		return x.Rank
	}
	return 0
...
func (x *HotScaleSummary) GetSubmissionCount() int64 {
	if x != nil {
...
func (x *HotScaleSummary) GetHeatScore() int64 {
	if x != nil {
		return x.HeatScore
	}
	return 0
...
type ListHotScalesRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Limit         int32                  `protobuf:"varint,1,opt,name=limit,proto3" json:"limit,omitempty"`                             // 返回数量，服务端限制为 3~5，默认 5
	WindowDays    int32                  `protobuf:"varint,2,opt,name=window_days,json=windowDays,proto3" json:"window_days,omitempty"` // 热度统计窗口，默认近 30 天
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *ListHotScalesRequest) Reset() {
	*x = ListHotScalesRequest{}
	mi := &file_scale_scale_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ListHotScalesRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListHotScalesRequest) ProtoMessage() {}

func (x *ListHotScalesRequest) ProtoReflect() protoreflect.Message {
	mi := &file_scale_scale_proto_msgTypes[9]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListHotScalesRequest.ProtoReflect.Descriptor instead.
func (*ListHotScalesRequest) Descriptor() ([]byte, []int) {
	return file_scale_scale_proto_rawDescGZIP(), []int{9}
}

func (x *ListHotScalesRequest) GetLimit() int32 {
	if x != nil {
		return x.Limit
	}
	return 0
...
func (x *ListHotScalesRequest) GetWindowDays() int32 {
	if x != nil {
		return x.WindowDays
	}
	return 0
...
type ListHotScalesResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Scales        []*HotScaleSummary     `protobuf:"bytes,1,rep,name=scales,proto3" json:"scales,omitempty"`
	Total         int64                  `protobuf:"varint,2,opt,name=total,proto3" json:"total,omitempty"`
...
func (x *ListHotScalesResponse) Reset() {
	*x = ListHotScalesResponse{}
	mi := &file_scale_scale_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ListHotScalesResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListHotScalesResponse) ProtoMessage() {}

func (x *ListHotScalesResponse) ProtoReflect() protoreflect.Message {
	mi := &file_scale_scale_proto_msgTypes[10]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListHotScalesResponse.ProtoReflect.Descriptor instead.
func (*ListHotScalesResponse) Descriptor() ([]byte, []int) {
	return file_scale_scale_proto_rawDescGZIP(), []int{10}
}

func (x *ListHotScalesResponse) GetScales() []*HotScaleSummary {
	if x != nil {
		return x.Scales
	}
	return nil
...
func (x *ListHotScalesResponse) GetTotal() int64 {
	if x != nil {
		return x.Total
	}
	return 0
...
func (x *ListHotScalesResponse) GetLimit() int32 {
	if x != nil {
		return x.Limit
	}
	return 0
...
func (x *ListHotScalesResponse) GetWindowDays() int32 {
	if x != nil {
		return x.WindowDays
	}
	return 0
...
func (x *Reporter) Reset() {
	*x = Reporter{}
	mi := &file_scale_scale_proto_msgTypes[15]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Reporter) Descriptor() ([]byte, []int) {
	return file_scale_scale_proto_rawDescGZIP(), []int{15}
}
...
func (x *Tag) Reset() {
	*x = Tag{}
	mi := &file_scale_scale_proto_msgTypes[16]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Tag) Descriptor() ([]byte, []int) {
	return file_scale_scale_proto_rawDescGZIP(), []int{16}
}
...
func (x *GetScaleCategoriesResponse) Reset() {
	*x = GetScaleCategoriesResponse{}
	mi := &file_scale_scale_proto_msgTypes[17]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetScaleCategoriesResponse) Descriptor() ([]byte, []int) {
	return file_scale_scale_proto_rawDescGZIP(), []int{17}
}
...
const file_scale_scale_proto_rawDesc = "" +
	...
	"\x0fHotScaleSummary\x12)\n" +
	"\x05scale\x18\x01 \x01(\v2\x13.scale.ScaleSummaryR\x05scale\x12\x12\n" +
	"\x04rank\x18\x02 \x01(\x05R\x04rank\x12)\n" +
	"\x10submission_count\x18\x03 \x01(\x03R\x0fsubmissionCount\x12\x1d\n" +
	"\n" +
	"heat_score\x18\x04 \x01(\x03R\theatScore\"M\n" +
	"\x14ListHotScalesRequest\x12\x14\n" +
	"\x05limit\x18\x01 \x01(\x05R\x05limit\x12\x1f\n" +
	"\vwindow_days\x18\x02 \x01(\x05R\n" +
	"windowDays\"\x94\x01\n" +
	"\x15ListHotScalesResponse\x12.\n" +
	"\x06scales\x18\x01 \x03(\v2\x16.scale.HotScaleSummaryR\x06scales\x12\x14\n" +
...
var file_scale_scale_proto_msgTypes = make([]protoimpl.MessageInfo, 19)
var file_scale_scale_proto_goTypes = []any{
	...
	(*HotScaleSummary)(nil),            // 8: scale.HotScaleSummary
	(*ListHotScalesRequest)(nil),       // 9: scale.ListHotScalesRequest
	(*ListHotScalesResponse)(nil),      // 10: scale.ListHotScalesResponse
	(*GetScaleCategoriesRequest)(nil),  // 11: scale.GetScaleCategoriesRequest
	(*ScaleCategory)(nil),              // 12: scale.ScaleCategory
	(*ScaleStage)(nil),                 // 13: scale.ScaleStage
	(*ApplicableAge)(nil),              // 14: scale.ApplicableAge
	(*Reporter)(nil),                   // 15: scale.Reporter
	(*Tag)(nil),                        // 16: scale.Tag
	(*GetScaleCategoriesResponse)(nil), // 17: scale.GetScaleCategoriesResponse
	nil,                                // 18: scale.Factor.ScoringParamsEntry
}
var file_scale_scale_proto_depIdxs = []int32{
	2,  // 0: scale.Scale.factors:type_name -> scale.Factor
	18, // 1: scale.Factor.scoring_params:type_name -> scale.Factor.ScoringParamsEntry
	...
	0,  // 5: scale.HotScaleSummary.scale:type_name -> scale.ScaleSummary
	8,  // 6: scale.ListHotScalesResponse.scales:type_name -> scale.HotScaleSummary
	12, // 7: scale.GetScaleCategoriesResponse.categories:type_name -> scale.ScaleCategory
	13, // 8: scale.GetScaleCategoriesResponse.stages:type_name -> scale.ScaleStage
	14, // 9: scale.GetScaleCategoriesResponse.applicable_ages:type_name -> scale.ApplicableAge
	15, // 10: scale.GetScaleCategoriesResponse.reporters:type_name -> scale.Reporter
	16, // 11: scale.GetScaleCategoriesResponse.tags:type_name -> scale.Tag
	4,  // 12: scale.ScaleService.GetScale:input_type -> scale.GetScaleRequest
	6,  // 13: scale.ScaleService.ListScales:input_type -> scale.ListScalesRequest
	9,  // 14: scale.ScaleService.ListHotScales:input_type -> scale.ListHotScalesRequest
	11, // 15: scale.ScaleService.GetScaleCategories:input_type -> scale.GetScaleCategoriesRequest
	5,  // 16: scale.ScaleService.GetScale:output_type -> scale.GetScaleResponse
	7,  // 17: scale.ScaleService.ListScales:output_type -> scale.ListScalesResponse
	10, // 18: scale.ScaleService.ListHotScales:output_type -> scale.ListHotScalesResponse
	17, // 19: scale.ScaleService.GetScaleCategories:output_type -> scale.GetScaleCategoriesResponse
