...
var MigratedModuleAssembleFiles = map[PackageName][]string{
	...
	PackageModelCatalog:   {"module_aggregate.go", "module_ports.go", "assemble_hot_rank.go", "assemble_typology.go", "assemble_norming.go", "assemble_taskperformance.go", "default_descriptors.go", "wire.go", "install.go"},
