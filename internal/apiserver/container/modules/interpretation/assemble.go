...
import (
	...
	aiexplanationsource "github.com/FangcunMount/qs-server/internal/apiserver/application/interpretation/reportsource"
...
type Module struct {
	...
	aiFlows                *bridge.FlowAdministration
...
func New(deps Deps) (*Module, error) {
	...
	module := &Module{}
	if deps.AIWorkflow != nil {
		module.aiWorkflowEnabled = deps.AIWorkflow.Enabled
	}
	...
	if deps.AIWorkflow != nil && (deps.AIWorkflow.Management.Enabled || module.aiWorkflowEnabled) {
		...
		if deps.AIWorkflow.Management.Enabled {
			...
			module.aiFlows = &bridge.FlowAdministration{Gateway: clients.Flows}
...
func (m *Module) AIWorkflowAssets() *bridge.AssetCatalogAdministration {
	if m == nil {
		return nil
	}
	return m.aiAssets
...
func (m *Module) AIWorkflowFlows() *bridge.FlowAdministration {
	if m == nil {
		return nil
	}
	return m.aiFlows
