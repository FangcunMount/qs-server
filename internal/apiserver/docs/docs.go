...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/v1/statistics/questionnaires/batch": {
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.questionnaireBatchRequest"
                        }
                    }
                ],
                "responses": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/statistics.QuestionnaireBatchStatisticsResponse"
                                        }
                                    }
                                }
                            ]
    ...
    "definitions": {
        ...
        "statistics.QuestionnaireBatchStatisticsItem": {
            "type": "object",
            "properties": {
                "code": {
                    "type": "string"
        ...
        "statistics.QuestionnaireBatchStatisticsResponse": {
            "type": "object",
            "properties": {
                "items": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/statistics.QuestionnaireBatchStatisticsItem"
                    }
                }
            }
        },
