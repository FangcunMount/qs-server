...
const docTemplate = `{
        ...
        "/api/v1/clinicians": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "兼容字段：机构ID，若传入必须与 JWT org_id 一致",
                        "name": "org_id",
                        "in": "query"
                    },
                    {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/response.ClinicianListResponse"
                                        }
                                    }
                                }
                            ]
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/response.AssessmentEntryListResponse"
                                        }
                                    }
                                }
                            ]
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/response.AssessmentEntryResolvedResponse"
                                        }
                                    }
                                }
                            ]
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/response.AssessmentEntryIntakeResponse"
                                        }
                                    }
                                }
                            ]
        ...
        "/api/v1/testees/by-profile-id": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "用户档案ID（IAM Child ID/ProfileID）",
                        "name": "profile_id",
                        "in": "query",
                        "required": true
                    },
    ...
    "definitions": {
        ...
        "response.AssessmentEntryIntakeResponse": {
            "type": "object",
            "properties": {
                "assignment": {
                    "$ref": "#/definitions/response.RelationResponse"
                },
                "clinician": {
                    "$ref": "#/definitions/response.ClinicianSummaryResponse"
                },
                "entry": {
                    "$ref": "#/definitions/response.AssessmentEntryResponse"
                },
        ...
        "response.AssessmentEntryListResponse": {
            "type": "object",
            "properties": {
                "items": {
                    "type": "array",
        ...
        "response.AssessmentEntryResolvedResponse": {
            "type": "object",
            "properties": {
                "clinician": {
                    "$ref": "#/definitions/response.ClinicianSummaryResponse"
        ...
        "response.AssessmentEntryResponse": {
            "type": "object",
            "properties": {
                "clinician_id": {
                    "type": "string"
        ...
        "response.ClinicianListResponse": {
            "type": "object",
            "properties": {
                "items": {
                    "type": "array",
        ...
        "response.ClinicianSummaryResponse": {
            "type": "object",
            "properties": {
                "clinician_type": {
                    "type": "string"
