...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/internal/v1/system-governance/actions/delivery-replay-reviews": {
            "get": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/systemgovernance.DeliveryReplayReviewPage"
                                        }
                                    }
                                }
                            ]
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/systemgovernance.PendingReplayAuditPage"
                                        }
                                    }
                                }
                            ]
    ...
    "definitions": {
        ...
        "systemgovernance.DeliveryReplayReview": {
            "type": "object",
            "properties": {
                "actor_user_id": {
                    "type": "string"
                ...
                "targets": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/systemgovernance.DeliveryReplayReviewTarget"
                    }
                },
                "targets_readable": {
                    "type": "boolean"
        ...
        "systemgovernance.DeliveryReplayReviewPage": {
            "type": "object",
            "properties": {
                "items": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/systemgovernance.DeliveryReplayReview"
                    }
                },
                "next_cursor": {
                    "type": "string"
        ...
        "systemgovernance.DeliveryReplayReviewTarget": {
            "type": "object",
            "properties": {
                "dead_letter_id": {
                    "type": "integer"
        ...
        "systemgovernance.PendingReplayAudit": {
            "type": "object",
            "properties": {
                "actor_user_id": {
                    "type": "string"
        ...
        "systemgovernance.PendingReplayAuditPage": {
            "type": "object",
            "properties": {
                "items": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/systemgovernance.PendingReplayAudit"
                    }
                },
                "next_cursor": {
                    "type": "string"
