...
func TestScaleInterpretationPublisherUpsertsPublishedScale(t *testing.T) {
	writer := &stubRuleWriter{}
	publisher := NewScaleInterpretationPublisher(writer)
	...
	if writer.last.Definition.Kind != domain.ModelKindScale {
