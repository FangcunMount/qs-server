...
func NewGlobalProjections(db *gorm.DB) []statisticsDomain.Projection {
...
func replaceWindow(ctx context.Context, db *gorm.DB, table, dateColumn, insertSQL string, request statisticsDomain.ProjectionRequest, args ...any) (int64, error) {
...
func (p *AccessDailyProjection) Project(ctx context.Context, r statisticsDomain.ProjectionRequest) (statisticsDomain.ProjectionResult, error) {
...
func (p *AssessmentDailyProjection) Project(ctx context.Context, r statisticsDomain.ProjectionRequest) (statisticsDomain.ProjectionResult, error) {
...
func (p *PlanActivityProjection) Project(ctx context.Context, r statisticsDomain.ProjectionRequest) (statisticsDomain.ProjectionResult, error) {
...
func (p *PlanFulfillmentProjection) Project(ctx context.Context, r statisticsDomain.ProjectionRequest) (statisticsDomain.ProjectionResult, error) {
	db := projectionDB(ctx, p.db)
	if err := db.Exec("DELETE FROM statistics_plan_fulfillment_daily WHERE org_id=?", r.OrgID).Error; err != nil {
		return statisticsDomain.ProjectionResult{Name: p.Name()}, err
	}
	result := db.Exec(`
...
func (p *OrganizationSnapshotProjection) Project(ctx context.Context, r statisticsDomain.ProjectionRequest) (statisticsDomain.ProjectionResult, error) {
