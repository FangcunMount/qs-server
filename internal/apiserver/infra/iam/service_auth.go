...
import (
	...
	auth "github.com/FangcunMount/iam/v3/pkg/sdk/auth/serviceauth"
...
func NewServiceAuthHelper(ctx context.Context, client *Client, config *ServiceAuthConfig) (*ServiceAuthHelper, error) {
	...
	if err != nil {
		// 当 IAM 端未实现 IssueServiceToken 时，返回 Unimplemented
...
func (h *ServiceAuthHelper) GetRequestMetadata(ctx context.Context, _ ...string) (map[string]string, error) {
	return pkgserviceauth.BearerRequestMetadata(ctx, h)
}
