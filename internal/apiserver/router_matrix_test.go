...
func TestHistoricalSeedRoutesAreRetiredAtRouterLevel(t *testing.T) {
	...
	for _, path := range []string{
		"/internal/v1/historical-seed/batches/batch-proof",
		"/internal/v1/historical-seed/batches/batch-proof/scenarios?scenario_id=scenario-proof",
		"/internal/v1/historical-seed/batches/batch-proof/scenarios/scenario-proof",
	} {
