...
func (participantAccessStub) AuthorizeParticipant(context.Context, participant.Actor) error {
	return nil
}
func (participantAccessStub) AuthorizeOwnAssessment(context.Context, uint64, uint64) error {
	return nil
}
