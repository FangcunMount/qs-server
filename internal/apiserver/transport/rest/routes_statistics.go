...
func (r *Router) registerStatisticsProtectedRoutes(apiV2 *gin.RouterGroup) {
	...
	statistics.GET("/operations/analysis/overview", r.rateLimitedHandlers(rateLimitBudgetQuery, h.AnalysisOverview)...)
	statistics.GET("/operations/analysis/clinicians", r.rateLimitedHandlers(rateLimitBudgetQuery, h.AnalysisClinicians)...)
	statistics.GET("/operations/analysis/entries", r.rateLimitedHandlers(rateLimitBudgetQuery, h.AnalysisEntries)...)
