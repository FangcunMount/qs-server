...
func TestProductionAIExplanationDeepSeekResponsesRollbackContract(t *testing.T) {
	...
	if ai.ProviderProtocol != apiserveroptions.AIExplanationProviderProtocolResponses ||
		ai.Evaluation.ProviderProtocol != apiserveroptions.AIExplanationProviderProtocolResponses {
		t.Fatalf("production AI provider protocols = %q/%q, want responses/responses", ai.ProviderProtocol, ai.Evaluation.ProviderProtocol)
	}
