...
var (
	...
	ErrIAMJWTConfigRequired       = errors.New("iam.jwt is required when IAM is enabled")
	ErrIAMJWTIssuerRequired       = errors.New("iam.jwt.issuer is required when IAM is enabled")
	ErrIAMJWTAudienceRequired     = errors.New("iam.jwt.audience is required when IAM is enabled")
	ErrIAMJWTAlgorithmUnsupported = errors.New("iam.jwt.algorithms only supports RS256")
