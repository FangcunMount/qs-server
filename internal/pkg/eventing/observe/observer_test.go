...
func TestOutcomeStringValuesAreStable(t *testing.T) {
	cases := map[string]string{
		...
		ConsumeOutcomeUnknownPersistFailed.String(): "unknown_persist_failed",
