...
func DefaultSpecs() []EventSpec {
	return []EventSpec{
		...
		durableSpec(EvaluationRetryRequested, "evaluation", OutboxProfileAssessmentMySQL, false, PriorityP1, "evaluation-latest-run-retry-decision"),
		...
		durableSpec(AIExplanationRequested, "interpretation/aiexplanation", OutboxProfileMongoDomain, true, PriorityP0, "generation-state-claim"),
		durableSpec(AIExplanationRetryRequested, "interpretation/aiexplanation", OutboxProfileMongoDomain, true, PriorityP0, "failed-run-retry-authorization"),
		durableSpec(AIExplanationLeaseRecoveryRequested, "interpretation/aiexplanation", OutboxProfileMongoDomain, true, PriorityP0, "exact-run-lease-wakeup-cas"),
		durableSpec(AIExplanationGenerated, "interpretation/aiexplanation", OutboxProfileMongoDomain, false, PriorityP1, "terminal-generation-reference-audit"),
		durableSpec(AIExplanationFailed, "interpretation/aiexplanation", OutboxProfileMongoDomain, false, PriorityP1, "terminal-failure-reference-audit"),
		durableSpec(AIExplanationPromptEvaluationStepRequested, "interpretation/aiexplanation", OutboxProfileMongoDomain, true, PriorityP1, "run-case-attempt-checkpoint-cas"),
