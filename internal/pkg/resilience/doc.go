// Package resilience defines the bounded vocabulary and observability
// contract for qs-server resilience controls.
//
// The package intentionally does not implement rate limiting, queues,
// backpressure, Redis locks, or business idempotency. Those primitives live in
// focused child packages. This package only provides shared decision labels so
